...
//Cannot resolve corresponding JNI function Java_com_android_example_fypapp_MainActivity_facedetect.

JNIEXPORT jobjectArray JNICALL
Java_com_android_example_fypapp_MainActivity_facedetect(JNIEnv *env,jobject /* this */,jlong matAddr)
{
     ...
     * 获取Face类以及其对于参数的签名
     */
    jclass faceClass = env->FindClass("com/android/example/fypapp/Face");//获取Face类
